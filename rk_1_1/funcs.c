...
//TODO: Change it if you need
static char is_clique_in_stack(stack_element_t *head, int num)
{
...
//TODO: find_cliques
error_t find_cliques(vertice_t *varray, int count)
{
	if (!varray || !count)
		return ERROR_INPUT;
	for (int i = 0; i < count; i++)
